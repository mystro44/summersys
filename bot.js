...
const client = new Discord.Client(NTM1MTI3OTUxODA5ODM5MTA1.D3rlRA.OSqe-zy5aGVMTWlnkYKbqND1W5Y);   
...
client.on('guildMemberAdd', member => {
    member.createDM().then(function (channel) {
return channel.send("508259209742123018")
    }
    )});
client.login(NTM1MTI3OTUxODA5ODM5MTA1.D3rlRA.OSqe-zy5aGVMTWlnkYKbqND1W5Y)
